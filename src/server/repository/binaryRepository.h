...
namespace test {
/**
 * @brief The BinaryRepository class предоставляющий функциональность для работы
 * с базой данных бинарных файлоф
 */
class BinaryRepository {
 public:
  ...
  /**
   * @brief getBinaryCount получение количества бинарных файлов полученных
   * сервером
